  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text
          fontSize={{ base: "9px", md: "10px", lg: "12px", "2xl": "small" }}
          ml="-180px"
        >
          JOIN OUR FREE LOYALTY PROGRAM TO RECEIVE A $10 BEAUTY CARD FOR EVERY
          $250 YOU SPEND.
        </Text>
        <Button
          bg="#12284c"
      ...
      <Box display="flex" justifyContent="flex-end" mt="80px" p="10px">
        <Box display="flex" flexDirection="column" mr="20px">
          ...
          <Box
            display="flex"
            justifyContent="flex-end"
            fontSize={{ base: "16px", md: "18px", lg: "20px", "2xl": "25px" }}
            color="#12284c"
          >
          ...
          <Box
            color="#a3acba"
            fontSize={{ base: "9px", md: "8px", lg: "10px", "2xl": "13px" }}
            mt="8px"
          >
      ...
      <Box display="flex" justifyContent="flex-end" mt="40px">
        <VStack>
          ...
          <HStack>
            <Text fontSize="10px">
              4 interest-free payments of $19.25 with Klarna.{" "}
      ...
      <Center
        ...
        fontWeight="light"
      >
        BEAUTY LOVERS LIKE YOU ALSO VIEWED
      </Center>
      <Center>
