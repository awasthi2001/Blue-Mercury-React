...
export const Signup = () => {
    ...
    const handleSignup = async (e) => {
        e.preventDefault();
        let usersRes = await fetch(`https://blue-mercury-3qiw.onrender.com/Users?email=${userData.email}`);
        ...
        let res = await fetch("https://blue-mercury-3qiw.onrender.com/Users", {
            method: 'POST',
