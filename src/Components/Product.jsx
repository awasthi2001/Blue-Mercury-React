...
export const Products = () => {
  ...
  return (
    <Flex mt="20">
      <Box w="500px" ml="8">
        <Categories setData={setData} setloading={setloading} p1={p1} Orderby={Orderby} page={Page} setTotalPages={setTotalPages}/>
        <Divider></Divider>
        {/* <Filters></Filters> */}
      </Box>
        ...
        {loading ? (
          ...
          >
            {data.map((el) => (
              ...
              >
                {" "}
                <Text ml="4" fontSize="sm" fontWeight="300">
                  {el.MerchBadge}{" "}
                </Text>{" "}
                <IconButton
                  bg={0}
                  icon={<TbHeartPlus fontSize={"25px"} />}
                  top={0}
                  right="1"
                  position="absolute"
                ></IconButton>
                <Image m="auto" h="65%" src={el.ProductCard__Image_src}></Image>
                <Button
                  id={el.id}
                  borderRadius="none"
                  border="transparent"
                  ...
                  w="90%"
                  color="transparent"
                  _hover={{ border: "1px solid black", color: "black" }}
                >
                  Quick View
                </Button>
                <Text textAlign="center">{el.ProductCard__Title} </Text>
                <Text textAlign="center" fontWeight="550">
                  ${el.ProductCard__Price}
                </Text>
                <Modal
